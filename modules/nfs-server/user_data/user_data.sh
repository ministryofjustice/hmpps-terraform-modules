...
cat << EOT >> /etc/exports
${nfs_share} ${allowed_ranges_1}(rw,sync,no_root_squash,no_all_squash) ${allowed_ranges_2}(rw,sync,no_root_squash,no_all_squash) ${allowed_ranges_3}(rw,sync,no_root_squash,no_all_squash)
EOT
